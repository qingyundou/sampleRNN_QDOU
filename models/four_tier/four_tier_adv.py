...
fixed_rand_h0_1 = numpy.random.rand(N_SEQS//2, N_RNN_LIST[1], H0_MULT*DIM)
fixed_rand_h0_1 -= 0.5
fixed_rand_h0_1 = fixed_rand_h0_1.astype('float32')

fixed_rand_h0_2 = numpy.random.rand(N_SEQS//2, N_RNN_LIST[2], H0_MULT*DIM)
fixed_rand_h0_2 -= 0.5
fixed_rand_h0_2 = fixed_rand_h0_2.astype('float32')
