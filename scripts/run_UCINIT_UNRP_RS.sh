...
#2.3 key cmd
#---------------------------key cmd
python -u models/three_tier/three_tier_con.py --exp $NAME --seq_len 800 --big_frame_size 80 --frame_size 20 --emb_size 256 --skip_conn False --dim 1024 --n_rnn 3 --rnn_type GRU --q_levels 256 --q_type mu-law --batch_size 20 --weight_norm True --learn_h0 True --which_set SPEECH --n_big_rnn 1 --normed --rmzero --grid
#---------------------------key cmd
